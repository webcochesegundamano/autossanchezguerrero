 ...
 * 
 * Extrae los coches del perfil de Wallapop de Autos Sanchez Guerrero
...
const WALLAPOP_PROFILE_URL = 'https://es.wallapop.com/user/luism-466989913';
...
// Función principal
async function main() {
    console.log('🚗 Autos Sanchez Guerrero - Importador Wallapop');
    console.log('================================================\n');
